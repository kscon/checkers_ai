...
class TestBoard:
    ...
    @pytest.mark.parametrize("current_player, source_col, source_row, target_col, target_row, expected_output",
                             [(0, 'a', 1, 'b', 2, (1, None)), (0, 'a', 1, 'd', 4, (-1, None)),  # a1 pawn
                              ...
                              (1, 'e', 5, 'c', 8, (1, None)), (1, 'e', 5, 'c', 3, (-1, None)),
                              (1, 'e', 5, 'g', 7, (-1, None)),  # e5 queen
                              (1, 'e', 5, 'c', 8, (1, None)), (0, 'e', 5, 'c', 8, (-1, None)),
                              (1, 'e', 5, 'h', 8, (-1, None)),
                              (1, 'e', 5, 'f', 6, (-1, None)),
                              (1, 'g', 2, 'h', 1, (1, None)), (1, 'g', 2, 'f', 1, (-1, None)),
                              (1, 'g', 2, 'h', 3, (-1, None)),  # g2 pawn
                              (0, 'g', 2, 'h', 1, (-1, None))
                              ])
    ...
    @pytest.mark.parametrize("scenario", [[('b', 2, 'white', 'pawn'),
                                           ...
                                           ('e', 5, 'black', 'queen'),
                                           ('f', 6, 'black', 'pawn')]])
    @pytest.mark.parametrize("source_col, source_row, target_col, target_row",
                             [('b', 2, 'd', 4), ('b', 2, 'g', 7),  # b2 pawn
                              ('b', 2, 'f', 6),
                              ('c', 3, 'd', 4), ('c', 3, 'e', 5),  # c3 queen
                              ('c', 3, 'f', 6), ('c', 3, 'a', 1),
                              ('c', 3, 'g', 7), ('c', 3, 'h', 8),
                              ('e', 5, 'd', 4), ('e', 5, 'c', 3),  # e5 queen
                              ('e', 5, 'b', 2), ('e', 5, 'a', 1),
                              ('e', 5, 'h', 8),
                              ('e', 5, 'h', 8),
                              ('f', 6, 'd', 4), ('f', 6, 'a', 1),  # f6 pawn
                              ('f', 6, 'b', 2)
                              ])
    def test_move_piece(self, scenario, source_col, source_row, target_col, target_row):
        board = Board(scenario)
        piece = board.get_field(source_col, source_row).get_Piece()
        board.move_piece(source_col, source_row, target_col, target_row)
        assert board.get_field(source_col, source_row).get_Piece() is None
        assert board.get_field(target_col, target_row).get_Piece() == piece
    ...
    @pytest.mark.parametrize("scenario", [[('a', 1, 'white', 'pawn'),
                                           ...
                                           ('g', 2, 'black', 'pawn')]])
    @pytest.mark.parametrize("current_player, source_col, source_row, target_col, target_row, expected_output",
                             [(0, 'a', 1, 'b', 2, None), (0, 'a', 1, 'd', 4, -1),  # a1 pawn
                              (0, 'c', 3, 'b', 2, None), (0, 'c', 3, 'a', 5, None),
                              (0, 'c', 3, 'e', 1, None),  # c3 queen
                              (0, 'c', 3, 'e', 5, -1), (0, 'c', 3, 'f', 6, -1),
                              (0, 'c', 3, 'g', 7, -1),
                              (0, 'b', 7, 'a', 8, None),  # b7 pawn
                              (0, 'f', 1, 'g', 2, -1), (0, 'f', 1, 'e', 2, None),
                              (1, 'f', 1, 'g', 2, -1),  # f1 pawn
                              (1, 'e', 5, 'c', 8, None), (1, 'e', 5, 'c', 3, -1),
                              (1, 'e', 5, 'g', 7, -1),  # e5 queen
                              (1, 'e', 5, 'c', 8, None), (0, 'e', 5, 'c', 8, -1),
                              (1, 'e', 5, 'h', 8, -1),
                              (1, 'e', 5, 'f', 6, -1),
                              (1, 'g', 2, 'h', 1, None), (1, 'g', 2, 'f', 1, -1),
                              (1, 'g', 2, 'h', 3, -1),  # g2 pawn
                              (0, 'g', 2, 'h', 1, -1)
                              ])
    def test_make_move(self, scenario, current_player, source_col, source_row, target_col, target_row, expected_output):
        board = Board(scenario)
        if current_player == 1:
